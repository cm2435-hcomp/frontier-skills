...
Create application-specific packages for LibreOffice Impress, Calc, Writer, Thunderbird, and VS Code. Keep universal
agent behavior in the base prompt and keep benchmark or evaluator contracts out of the registry.
...
| GIMP export focus and VLC instance handling | Deferred | One concrete regression each; below the three-failure package threshold |
| Chrome additions from PR #13222 | Deferred | The prompt iteration has not completed a suite evaluation |
